-- Let the lead pastor change ANY role, including demoting another lead
-- pastor — previously only the owner could touch a lead pastor's role.
-- Ownership itself still can't be handed off through this function.
